...
const QuizRules: React.FC<Props> = (props) => {
  ...
  return (
    <div>
      ...
      <p>
        {" "}
        2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You must take the exam in the same room
        that you scanned during the proctoring setup for the current exam..
      </p>
      <p>
        {" "}
        3.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No other person is allowed to enter the
        room while you are taking the proctored exam.
      </p>
      <p>
        {" "}
        4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You must sit at a clean desk or table.
        Items like book, paper, pens, textbook shouldn't be on the table.
      </p>
      <p>
        {" "}
      ...
      <p>
        {" "}
        6.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The computer you are using to take the
        exam must not have more than one display or monitor. For example, if you
        usually use a &nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;laptop with a
        monitor connected, disconnect your monitor and use only the laptop
        screen.
      </p>
      <p>
        {" "}
      ...
      <p>
        ...
        rules and receive an Unsatisfactory status, you automatically receive a
        score of 0 for the exam. For &nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;most courses, you
        are no longer eligible for academic credit.
      </p>
      <p className="text-xl font-bold">QUIZ CONFIGURATIONS</p>
      {getQuizConfigs()}
      <div className="flex flex-row gap-6 items-center justify-center text-xl">
        <input type="checkbox" onClick={handleClick} /> <b>Agree Quiz Rules </b>
      </div>
    </div>
  );
};
